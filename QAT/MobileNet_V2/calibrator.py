...
def get_calib_data_path():
    img_paths = []
    data_root = "/data/lijiang/code/dipoorlet/chapter_three/tiny-imagenet-200/val/"
...
class CalibDataLoader:
    def __init__(self, batch_size, calib_count):
        self.data_root = "/data/lijiang/code/dipoorlet/chapter_three/tiny-imagenet-200/val/images/"
        self.index = 0
...
def get_dipoorlet_calib():
    data_root = "/data/lijiang/code/dipoorlet/chapter_three/tiny-imagenet-200/val/images/"
